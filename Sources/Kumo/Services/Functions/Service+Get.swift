...
public extension Service {
    ...
    func get<Response: Decodable>(_ endpoint: String, parameters: [String: Any] = [:], keyedUnder key: String? = nil) -> Observable<Response> {
    ...
    @available(*, deprecated, message: "Use Service.perform instead.")
    func get(_ endpoint: String, parameters: [String: Any] = [:]) -> Observable<Any> {
        return dataTask(method: .get, endpoint, parameters: parameters)
    }
